...
export const description = "Delete instances in batch by GUID. Each item specifies a guid to remove from the level.";

export const params = z
  .object({
    items: z
      .array(z.object({ guid: z.string().describe("GUID of the instance to delete") }))
      .min(1)
