...
export const description =
  ...
  "Call it with no arguments to read the current scale, and set it back to 1 before judging anything about " +
  "timing or feel, because at any other scale the pace you observe is not the pace a player gets. " +
