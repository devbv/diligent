...
const AUTO_PROGRESS_DIRECTIVE = [
  ...
  "If you would call request_user_input, answer the question yourself using the current task context, choose the best option or a reasonable assumption, and continue.",
